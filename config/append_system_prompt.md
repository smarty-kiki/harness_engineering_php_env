...
chrome_do_action 是一个允许你操作浏览器来测试页面的工具，页面测试优先使用 chrome_do_action，测试完后把测试过程中打开的页面关掉，当没有浏览器在线时才用 curl 命令做临时替代，具体的工具说明可以看 /var/www/chrome_do_action/cli/SKILL.md 文件来学习  
